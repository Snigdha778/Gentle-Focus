...
import bunnyJumping from "../imports/image-5.png";
import bunnyHome from "../imports/image-17.png";
import leafIcon from "../imports/ChatGPT_Image_Apr_25,_2026,_09_57_02_PM_1.png";
import moonIcon from "../imports/ChatGPT_Image_Apr_25,_2026,_09_56_56_PM_1.png";
import leafBreakIcon from "../imports/ChatGPT_Image_Apr_25,_2026,_09_57_02_PM_1-1.png";
import moonBreakIcon from "../imports/ChatGPT_Image_Apr_25,_2026,_09_56_56_PM_1-1.png";
import bunnyComplete from "../imports/image-18.png";
import bunnyReward from "../imports/Container/c3ad81675ccd0ccbec593959999f09953417daad.png";
import trashSvgPaths from "../imports/TablerTrashFilled/svg-tmprz6tthq";
...
:root {
  ...
  --gold:         #B8645B;
  --gold-light:   #B8645B;
  --gold-faint:   rgba(184,100,91,0.12);
  --gold-ring:    rgba(184,100,91,0.22);
...
body::before {
  ...
  background-image:
    radial-gradient(ellipse 80% 60% at 20% 10%, rgba(184,128,90,0.05) 0%, transparent 60%),
...
.flow-badge-val   { font-family: 'DM Serif Display', serif; font-size: 15px; color: var(--ink); }
...
.btn-icon {
  ...
  cursor: pointer; box-shadow: 0 1px 10px rgba(24,20,15,0.2);
...
.btn-icon:hover { background: #2c2520; box-shadow: 0 4px 10px rgba(24,20,15,0.3); transform: translateY(-1px); }
...
.orb-ring-2 {
  ...
  border-radius: 50%;
  border: 1px solid rgba(184,128,90,0.1);
...
.home-hero h1 {
  ...
  color: var(--ink); margin-bottom: 24px; font-weight: 400;
}
.home-hero h1 em { font-style: italic; color: var(--gold); }
.home-hero p {
  font-size: 15px; color: var(--ink-55);
  font-weight: 400; line-height: 1.6; max-width: 340px;
  margin: 0 auto;
}
...
.pending-tasks {
  ...
  box-shadow: 0 4px 12px rgba(24,20,15,0.08), 0 2px 4px rgba(24,20,15,0.04);
}
.pending-header {
...
.pending-more-btn:hover {
  background: var(--parchment-2);
  color: var(--ink);
}

/* ═══════════════════════════════════════
   MODAL OVERLAY (Flow Panel & Reason Modal)
═══════════════════════════════════════ */
.flow-panel-overlay,
...
.reason-modal {
  ...
  width: 100%;
  max-width: 480px;
  box-shadow: 0 20px 60px rgba(24,20,15,0.25), 0 8px 24px rgba(24,20,15,0.15);
...
.flow-panel-top {
  ...
  background: linear-gradient(135deg, rgba(184,128,90,0.06) 0%, transparent 60%);
  border-bottom: 1px solid var(--border);
  display: flex; align-items: center; justify-content: space-between;
}
...
.flow-score-ring-fill  {
  ...
  filter: drop-shadow(0 0 4px rgba(184,128,90,0.3));
}
.flow-score-center {
...
.btn-primary {
  ...
  box-shadow: 0 1px 10px rgba(24,20,15,0.2);
  transition: all 0.18s var(--ease-out);
  -webkit-tap-highlight-color: transparent;
}
.btn-primary:hover {
  box-shadow: 0 4px 10px rgba(24,20,15,0.3);
  transform: translateY(-2px);
}
.btn-primary:active  { transform: scale(0.98); box-shadow: 0 0 1px rgba(24,20,15,0.1), 0 5px 10px rgba(24,20,15,0.2); }
...
.btn-secondary {
  ...
  cursor: pointer; letter-spacing: -0.01em;
  margin-top: 12px; box-shadow: 0 1px 10px rgba(24,20,15,0.2);
  transition: all 0.18s var(--ease-out);
  -webkit-tap-highlight-color: transparent;
}
.btn-secondary:hover {
...
.btn-secondary:active { transform: scale(0.98); box-shadow: var(--shadow-xs); }
...
.field-label {
  font-size: 16px; letter-spacing: 0.09em; text-transform: uppercase;
...
.time-chip.active {
  ...
  box-shadow: 0 4px 12px rgba(24,20,15,0.12), 0 2px 4px rgba(24,20,15,0.06);
  transform: translateY(-1px);
}
...
.custom-time-row { display: flex; align-items: center; gap: 10px; }
.custom-time-input {
  width: 72px;
...
/* ═══════════════════════════════════════
   FOCUS SCREEN
═══════════════════════════════════════ */
.focus-screen { padding-top: 10px; text-align: center; }
.focus-task-eyebrow {
...
.timer-progress {
  ...
  filter: drop-shadow(0 0 6px rgba(184,128,90,0.35));
}
...
.ctrl-icon {
  ...
  display: flex; align-items: center; justify-content: center;
  font-size: 20px; box-shadow: 0 4px 12px rgba(24,20,15,0.08), 0 2px 4px rgba(24,20,15,0.04);
  transition: background 0.2s, transform 0.2s var(--ease-out),
              box-shadow 0.2s;
}
.ctrl-btn:hover .ctrl-icon {
  background: var(--ivory-2);
  box-shadow: 0 8px 24px rgba(24,20,15,0.12), 0 4px 8px rgba(24,20,15,0.06);
  transform: translateY(-2px) scale(1.04);
}
.ctrl-btn:active .ctrl-icon { transform: scale(0.93); box-shadow: none; }
.ctrl-btn.primary .ctrl-icon {
  background: var(--ink); border-color: var(--ink);
  color: var(--parchment); width: 58px; height: 58px; border-radius: 18px;
  box-shadow: 0 6px 20px rgba(24,20,15,0.15), 0 3px 8px rgba(24,20,15,0.1);
  font-size: 20px;
}
.ctrl-btn.primary:hover .ctrl-icon {
  background: #2c2520;
  transform: translateY(-2px) scale(1.04);
  box-shadow: 0 10px 32px rgba(24,20,15,0.2), 0 5px 12px rgba(24,20,15,0.12);
}
.ctrl-label {
...
.btn-complete {
  ...
  box-shadow: 0 4px 12px rgba(79,120,99,0.1), 0 2px 4px rgba(79,120,99,0.06);
  -webkit-tap-highlight-color: transparent;
}
.btn-complete:hover {
  background: rgba(79,120,99,0.13);
  transform: translateY(-1px);
  box-shadow: 0 8px 24px rgba(79,120,99,0.15), 0 4px 8px rgba(79,120,99,0.08);
}
...
.break-sheet {
  ...
  box-shadow: 0 6px 20px rgba(24,20,15,0.1), 0 3px 8px rgba(24,20,15,0.06);
  margin-bottom: 18px;
...
.break-sheet-label {
  ...
  color: var(--ink-35); font-weight: 600; margin-bottom: 24px; text-align: center;
}
.break-options { display: flex; gap: 12px; margin-bottom: 24px; }
.break-opt {
  flex: 1; padding: 28px 16px; cursor: pointer;
  background: var(--parchment);
  border: 1.5px solid var(--border-md);
  border-radius: var(--r-md);
...
.break-opt:hover {
  ...
  transform: translateY(-2px);
  box-shadow: 0 6px 18px rgba(24,20,15,0.1), 0 3px 6px rgba(24,20,15,0.05);
}
.break-opt:active { transform: scale(0.97); }
.break-opt-emoji { font-size: 28px; margin-bottom: 12px; display: block; }
.break-opt-icon { width: 56px; height: 56px; margin: 0 auto 14px; display: block; animation: floatIcon 3s ease-in-out infinite; }
.break-opt-name { font-size: 16px; font-weight: 600; color: var(--ink); margin-bottom: 4px; letter-spacing: -0.01em; }
.break-opt-time { font-size: 13px; color: var(--ink-35); font-weight: 400; }
...
/* ═══════════════════════════════════════
   COMPLETION SCREEN
═══════════════════════════════════════ */
.completion-screen { text-align: center; padding-top: 40px; }
.completion-emblem {
...
.reward-reveal {
  background: #7F3833;
  border: 0.8px solid rgba(139,99,64,0.18);
  border-radius: 28px;
  padding: 30px 25px;
  margin-bottom: 32px;
  box-shadow: 0px 3px 16.4px 0px rgba(24,20,15,0.53), 0px 2px 4px 0px rgba(24,20,15,0.04);
...
.stats-trio { display: flex; gap: 12px; margin-bottom: 32px; animation: headIn 0.45s 0.3s var(--ease-out) both; }
.stat-card {
...
.stat-card:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(24,20,15,0.12), 0 4px 8px rgba(24,20,15,0.06); }
.stat-num {
  font-family: 'DM Serif Display', serif;
  font-size: 28px; letter-spacing: -0.03em;
  color: var(--ink); display: block; margin-bottom: 6px;
}
.stat-desc { font-size: 12px; color: var(--ink-35); font-weight: 500; }
...
.history-summary {
  display: flex; gap: 10px; margin-bottom: 50px;
}
.hsumm-card {
...
.hsumm-card:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(24,20,15,0.12), 0 4px 8px rgba(24,20,15,0.06); }
.hsumm-val {
  font-family: 'DM Serif Display', serif;
...
.history-item-head { display: flex; align-items: center; justify-content: space-between; gap: 12px; margin-bottom: 8px; }
.history-item-name {
...
.footer-credit {
  ...
  padding-top: 50px; padding-bottom: 4px;
...
.bunny-home {
  ...
  filter: drop-shadow(0 8px 24px rgba(184,128,90,0.15));
}
...
.bunny-paused {
  animation: bunnyBreathe 3s ease-in-out infinite;
  margin-bottom: 10px;
  filter: drop-shadow(0 6px 18px rgba(184,128,90,0.12));
}
@keyframes bunnyBreathe {
  0%, 100% { transform: scale(1); }
  50% { transform: scale(1.03); }
}
.bunny-complete {
  margin-bottom: 10px;
  filter: drop-shadow(0 10px 30px rgba(184,128,90,0.2));
}
.bunny-perfect {
  animation: bunnyJumpIn 0.6s var(--spring) both, bunnyHop 1.5s ease-in-out 0.6s infinite;
}
.bunny-gentle {
  animation: bunnySlideIn 0.5s var(--ease-out) both, bunnyNod 2s ease-in-out 0.5s infinite;
}
.bunny-supportive {
  animation: bunnyFadeIn 0.6s var(--ease-out) both, bunnyBreathe 3s ease-in-out 0.6s infinite;
}
@keyframes bunnyJumpIn {
...
@media (max-width: 380px) {
  ...
  .ctrl-btn.primary .ctrl-icon { width: 52px; height: 52px; border-radius: 16px; }
...
@media (min-width: 640px) {
  .app { padding: 0 50px 120px; }
  .topbar { padding-top: 50px; }
}
...
function calcScore(history) {
  ...
  history.forEach((h) => {
    ...
    if (h.status === "stopped" || h.status === "paused") {
      score += 1;
    }
    if (h.breakBehavior === "returned") {
      score += 1;
      returned++;
    }
  });
...
const TrashIcon = () => (
  <svg width="23" height="23" viewBox="0 0 23 23" fill="none">
    <rect fill="#F1EFEC" height="23" rx="11.5" width="23" />
    <path d={trashSvgPaths.p1a121b80} fill="#272727" />
  </svg>
);
...
───────────────────────────────────────── */
const BunnyComplete = () => (
  <div style={{ position: 'relative', width: '140px', margin: '0 auto 24px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
    <div style={{
      position: 'absolute',
      width: '138px',
      height: '138px',
    ...
    <img
      ...
      src={bunnyComplete}
      style={{ width: '140px', height: 'auto', display: 'block', position: 'relative', zIndex: 1, animation: 'floatBunny 3.5s ease-in-out infinite' }}
    />
  </div>
);
...
export default function GentleFocus() {
  ...
  const [pauseMode, setPauseMode] = useState(false); // true = pause, false = stop
  const [showTimeCompletedPopup, setShowTimeCompletedPopup] = useState(false);
      ...
      timerRef.current = setInterval(() => {
        setSecondsLeft((s) => {
          if (s <= 1) {
            ...
            setShowTimeCompletedPopup(true);
            return 0;
          }
          return s - 1;
        });
  ...
  const pendingTasks = history.filter(
    (h) => h.status === "stopped" || h.status === "paused",
  );
  const {
    score,
  ...
  const encouragement =
    ENCOURAGEMENTS[history.length % ENCOURAGEMENTS.length];
  ...
  const progress =
    totalSeconds > 0
      ? Math.max(0, secondsLeft / totalSeconds)
      : 0;
  const R = 106,
    C = 2 * Math.PI * R;
  ...
  const breakProgress =
    breakTotalSecs > 0
      ? Math.max(0, breakSecsLeft / breakTotalSecs)
      : 0;
  const BR = 72,
    BC = 2 * Math.PI * BR;
  ...
  function startTask() {
    ...
    setElapsed(0);
    setExtensionsAdded(0);
    setBreakBehavior(null);
    setBreakType(null);
    setBreakExtended(false);
  ...
  function deleteTask(taskId) {
    setHistory((prev) => prev.filter((x) => x.id !== taskId));
  }
  ...
  function startBreak(type) {
    ...
    setBreakTotalSecs(secs);
    setBreakExtended(false);
  }
  function endBreak() {
    clearInterval(breakRef.current);
    if (breakBehavior !== "extended")
      setBreakBehavior("returned");
    setBreakType(null);
    setBreakExtended(false);
    setTimerState("running");
  }
  function pauseTask() {
    // Pause the timer and show reason modal
    setTimerState("paused");
    setPauseMode(true);
  ...
  function finishTask(forced = false) {
    if (forced && secondsLeft > 0) {
      // Show reason modal for stopped tasks
      clearAll();
      setPauseMode(false);
      setShowReasonModal(true);
      return;
  ...
  function handleTimeCompletedMarkComplete() {
    setShowTimeCompletedPopup(false);
    finishTask(false);
  }

  function handleTimeCompletedExtend() {
    setShowTimeCompletedPopup(false);
    setSecondsLeft((s) => s + 600);
    setTotalSeconds((t) => t + 600);
    setExtensionsAdded((e) => e + 10);
    setTimerState("running");
  }

  function completeStoppedTask() {
    clearAll();

    // Create a record for stopped/paused task
    const record = {
      ...activeTask,
      id: activeTask?.id || Date.now(),
      status: pauseMode ? "paused" : "stopped",
      elapsed,
      originalMins: activeTask?.mins,
      extensionsAdded,
      completedAt: Date.now(),
    ...
    setStopReason("");
    setPauseMode(false);
    setTask({ title: "", desc: "", mins: 25, reward: "" });
    setCustomMins("");
  ...
  return (
    <>
      ...
      <div className="app">
        ...
        <div className="topbar">
          ...
          <div className="topbar-right">
            {screen === "home" && (
              <>
                <button
                  ...
                  onClick={() => setShowFlowPanel((p) => !p)}
                  title="Your flow score"
                >
                  <div className="flow-badge-dot" />
                  <span className="flow-badge-label">Flow</span>
                  <span className="flow-badge-val">
                    {scoreDisplay}
                  </span>
                </button>
                <button
            ...
            {screen === "create" && (
              <button className="back-btn" onClick={goHome} style={{ margin: 0, lineHeight: '1' }}>
        ...
        {screen === "home" && (
          <div className="screen">
            ...
            <div className="home-hero">
              <div className="bunny-container" style={{
                width: '180px',
                margin: '0 auto 32px',
                position: 'relative'
              }}>
                <div style={{
                  position: 'absolute',
                  inset: '-40px',
                  background: 'radial-gradient(circle, rgba(255,154,111,0.15) 0%, transparent 70%)',
                  pointerEvents: 'none',
                  zIndex: -1
                }} />
                <img
                  alt="Gentle bunny mascot"
                  src={bunnyHome}
                  style={{
                    width: '100%',
                    height: 'auto',
                    display: 'block',
                    animation: 'floatBunny 3.5s ease-in-out infinite'
                  }}
                />
              </div>
              ...
              <h1>
                Focus on what <em>matters now</em>
              </h1>
              <p>
                No, pressure no guilt
                <br />
                Just one gentle step forward
              </p>
            </div>
            ...
            {pendingTasks.length > 0 && (
              <div className="pending-tasks">
                <div className="pending-header">
                  ...
                  <span className="pending-count-pill">
                    {pendingTasks.length}
                  </span>
                </div>
                    ...
                    <div className="pending-item-left">
                      ...
                      <div>
                        ...
                        <div className="pending-meta">
                          {h.originalMins}{(h.extensionsAdded || 0) > 0 ? ` + ${h.extensionsAdded}` : ''} min ·{" "}
                          {fmtDuration(h.elapsed)} done
                        </div>
                      </div>
                    </div>
                ...
                {pendingTasks.length > 3 && (
                  <button
                    className="pending-more-btn"
                    onClick={() => setScreen("history")}
                  >
                    View {pendingTasks.length - 3} more paused task{pendingTasks.length - 3 > 1 ? 's' : ''}
                  </button>
                )}
              </div>
            )}
        ...
        {/* ══════════════════════ CREATE ══════════════════════ */}
        {screen === "create" && (
          <div className="screen create-screen-new" data-version="v2">
            <style>{`
              /* Create Screen v2 - Updated Design */
              .create-screen-new .logo {
                line-height: 1 !important;
                display: flex !important;
                align-items: center !important;
              }
              .create-screen-new .back-btn {
              ...
              .create-screen-new .back-btn:hover {
                opacity: 0.7 !important;
              }
              .create-screen-new .back-arrow {
                display: flex !important;
                align-items: center !important;
                justify-content: center !important;
              }
              .create-screen-new .screen-eyebrow {
              ...
              .create-screen-new .screen-heading {
                text-align: left !important;
                margin-bottom: 32px !important;
              }
              .create-screen-new .form-card {
                background: #FDFBF8 !important;
                border-radius: 28px !important;
                padding: 32px 28px !important;
                box-shadow: 0 4px 12px rgba(24,20,15,0.08), 0 2px 4px rgba(24,20,15,0.04) !important;
                border: 1px solid rgba(24,20,15,0.07) !important;
                margin-bottom: 24px !important;
              }
              .create-screen-new .field-label {
                text-transform: uppercase !important;
                font-size: 11px !important;
                letter-spacing: 0.08em !important;
                color: rgba(24,20,15,0.35) !important;
                font-weight: 600 !important;
                margin-bottom: 10px !important;
              }
              .create-screen-new .field-input {
                border-radius: 14px !important;
                padding: 14px 18px !important;
                font-size: 15px !important;
                border: 1px solid rgba(24,20,15,0.15) !important;
                background: #F5F2EC !important;
                transition: all 0.2s ease !important;
              }
              .create-screen-new .field-input:hover {
                background: white !important;
                border: 1px solid rgba(184,100,91,0.33) !important;
              }
              .create-screen-new .field-input:focus {
                background: white !important;
                border: 1px solid rgba(184,100,91,0.5) !important;
                box-shadow: 0px 0px 3.6px 3px rgba(232,195,177,0.46) !important;
                outline: none !important;
              }
              .create-screen-new .time-chip {
              ...
              .create-screen-new .time-chip.active {
                background: #18140F !important;
                color: #F5F2EC !important;
                border: 1px solid #18140F !important;
                box-shadow: 0px 4px 12px 0px rgba(24,20,15,0.12), 0px 2px 4px 0px rgba(24,20,15,0.06) !important;
              }
              .create-screen-new .time-chip:not(.active) {
                background: #F5F2EC !important;
                color: rgba(24,20,15,0.55) !important;
                border: 1px solid rgba(24,20,15,0.15) !important;
              }
              .create-screen-new .time-chip:not(.active):hover {
                background: #EDE9E1 !important;
                border: 1px solid rgba(24,20,15,0.25) !important;
              }
              .create-screen-new .custom-time-input {
              ...
              .create-screen-new .custom-time-input:hover {
                background: white !important;
                border: 1px solid rgba(24,20,15,0.25) !important;
              }
              .create-screen-new .custom-time-input:focus {
                background: white !important;
                border: 1px solid rgba(184,100,91,0.5) !important;
                outline: none !important;
              }
              .create-screen-new .custom-time-label {
                font-size: 13px !important;
                color: rgba(24,20,15,0.35) !important;
              }
              .create-screen-new .custom-time-row {
                display: flex !important;
                align-items: center !important;
                gap: 10px !important;
                margin-left: auto !important;
              }
              .create-screen-new .form-divider {
                height: 1px !important;
                background: rgba(24,20,15,0.07) !important;
                margin: 24px 0 !important;
              }
              .create-screen-new .btn-primary {
                width: 100% !important;
              ...
              .create-screen-new .btn-primary:hover:not(:disabled) {
                background: #2a2420 !important;
                transform: translateY(-1px) !important;
                box-shadow: 0 4px 12px rgba(24,20,15,0.2) !important;
              }
              .create-screen-new .btn-primary:active:not(:disabled) {
          ...
          <div className="screen focus-screen">
            ...
            {activeTask && (
              <div style={{
                ...
                {activeTask.mins} min{extensionsAdded > 0 ? ` + ${extensionsAdded} min` : ''}
              </div>
            )}
            ...
            <div className="timer-ring-wrap">
              ...
              <div className="timer-center">
                <span
                  className={`timer-digits${timerState === "paused" ? " paused" : ""}`}
                >
                  {timerState === "overtime"
                    ? `+${fmt(elapsed - totalSeconds)}`
                    : fmt(secondsLeft)}
                </span>
            ...
            {timerState === "overtime" && (
              <div className="overtime-note">
                You've taken a bit more time than planned.
                <br />
                That's completely fine — keep going.
              </div>
            )}
            ...
            {showBreakSheet && (
              <div className="break-sheet">
                <div className="break-sheet-label">
                  Take a moment
                </div>
                <div className="break-options">
                  <button
                    className="break-opt"
                    onClick={() => startBreak("quick")}
                  >
                    <img src={leafIcon} alt="" className="break-opt-icon" />
                    <div className="break-opt-name">
                      Quick Reset
                    </div>
                    <div className="break-opt-time">
                      5 minutes
                    </div>
                  </button>
                  <button
                    className="break-opt"
                    onClick={() => startBreak("deep")}
                  >
                    <img src={moonIcon} alt="" className="break-opt-icon" />
                    <div className="break-opt-name">
                      Deep Pause
                    </div>
                    <div className="break-opt-time">
        ...
        {screen === "focus" && breakType && (
          <div className="screen break-screen">
            <div className="break-emoji-wrap">
              <img
                src={breakType === "quick" ? leafBreakIcon : moonBreakIcon}
                alt=""
                style={{ width: '80px', height: '80px', display: 'block', animation: 'floatIcon 3s ease-in-out infinite' }}
              />
            </div>
            ...
            <div className="break-ring-wrap">
              ...
              <svg
                className="break-ring-svg"
                width="168"
                height="168"
                viewBox="0 0 168 168"
              >
                <circle
                  className="break-ring-track"
                  cx="84"
                  cy="84"
                  r={BR}
                />
                <circle
                  className="break-ring-fill"
                  cx="84"
                  cy="84"
                  r={BR}
                  strokeDasharray={BC}
                  strokeDashoffset={breakDash}
                />
              </svg>
              <div className="break-ring-center">
                <div className="break-time-digits">
                  {fmt(breakSecsLeft)}
                </div>
                <div className="break-time-label">
                  {breakExtended ? "extended" : "remaining"}
                </div>
              </div>
            </div>
            ...
            {breakExtended && (
              <div className="extended-notice">
                <div className="extended-notice-title">
                  Looks like you needed a little more time.
                </div>
                <div className="extended-notice-body">
                  That's completely okay. Your session is still
        ...
        {screen === "completion" && completionData && (
          <div className="screen completion-screen">
            ...
            <div className="completion-headline" style={{ marginBottom: '12px' }}>
              Congrats!!
            </div>
            <div style={{
              ...
              On Completing {completionData.title}
            </div>

            {completionData.reward &&
              (completionData.status === "done" || completionData.status === "longer") && (
                <div className="reward-reveal">
                  <img src={bunnyReward} alt="" className="reward-icon" />
            ...
            <div className="stats-trio">
              <div className="stat-card">
                <span className="stat-num">
                  {fmtDuration(completionData.elapsed)}
                </span>
              ...
              <div className="stat-card">
                <span className="stat-num">
                  {completionData.originalMins}m{(completionData.extensionsAdded || 0) > 0 ? ` + ${completionData.extensionsAdded}m` : ''}
                </span>
                      ...
                      >
                        <div className="history-item-head">
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                            ...
                            <span
                              className={`h-status ${s.hClass}`}
                            >
                              {s.tag}
                            </span>
                            {(h.status === "stopped" || h.status === "paused") && (
                              <button
                        ...
                        <div className="history-item-meta">
                          ...
                          <span>
                            {h.originalMins}{(h.extensionsAdded || 0) > 0 ? ` + ${h.extensionsAdded}` : ''} min planned
                          </span>
                          {h.completedAt && (
                            <>
                        ...
                        {h.stopReason && (
                          <div className="stop-reason">
                            <div className="stop-reason-label">Why paused:</div>
                            <div className="stop-reason-text">{h.stopReason}</div>
                          </div>
                        )}
                      </div>
                    );
      ...
      {/* Flow Score Panel Overlay */}
      {showFlowPanel && (
        <div
          className="flow-panel-overlay"
          ...
          <div className="flow-panel" onClick={(e) => e.stopPropagation()}>
            <div className="flow-panel-top">
              <div className="flow-panel-title-block">
                <div className="flow-panel-eyebrow">
                  YOUR MOMENTUM
                </div>
            ...
            <div className="flow-ring-area">
              <div className="flow-score-ring-wrap">
                <svg
                  className="flow-score-ring-svg"
                  width="100"
                  height="100"
                  viewBox="0 0 100 100"
                >
                  <circle
                    className="flow-score-ring-track"
                    cx="50"
                    cy="50"
                    r={SR}
                  />
                  <circle
                    className="flow-score-ring-fill"
                    cx="50"
                    cy="50"
                    r={SR}
                    strokeDasharray={SC}
                ...
                <div className="flow-score-center">
                  <span className="flow-score-number">
                    {scoreDisplay}
                  </span>
                  <span className="flow-score-lbl">
                    pts
                  </span>
                </div>
              </div>
              <div className="flow-score-info">
                <div className="flow-score-tagline">
                  "{encouragement}"
                </div>
                <div className="flow-stats-row">
                  {[
                    ...
                    <div key={l} className="flow-stat">
                      <span className="flow-stat-val">
                        {v}
                      </span>
                      <span className="flow-stat-lbl">
                        {l}
                      </span>
                    </div>
                  ))}
        ...
        <div className="reason-modal-overlay">
          <div className="reason-modal" onClick={(e) => e.stopPropagation()}>
            <div className="reason-modal-title">
              Looks like you need some more time
            </div>
            <div className="reason-modal-subtitle">
              If you've completed your task, mark it as done. Otherwise, you can extend your session.
            </div>
            <button
              className="btn-primary"
              onClick={handleTimeCompletedMarkComplete}
            ...
            <button
              className="btn-secondary"
              onClick={handleTimeCompletedExtend}
      ...
      {/* Reason Modal for Stopped/Paused Tasks */}
      {showReasonModal && (
        <div
          className="reason-modal-overlay"
          onClick={pauseMode ? undefined : completeStoppedTask}
        >
          <div className="reason-modal" onClick={(e) => e.stopPropagation()}>
            {pauseMode && (
              <button
            ...
            <div className="reason-modal-title">
              Why did you pause this task?
            </div>
            <div className="reason-modal-subtitle">
              It's okay to pause. Reflecting on why helps build awareness for next time (optional).
            </div>
            <textarea
              className="reason-textarea"
              placeholder="I paused because..."
              value={stopReason}
